        ...
        return (
            <div className="flex flex-col items-center h-[100vh] gap-8 p-10">
                <div className="h-[180px] w-[200px] ">
                    <img src={yummyLogo} alt="yummy-logo" />
                </div>
                <div className="flex flex-col gap-2">
                    <span className="text-gray-800 dark:text-gray-200 text-3xl font-medium">Welcome to Yummy</span>
                ...
                <div className="flex flex-col gap-5 w-[100%]">
                    ...
                    <button className="flex items-center gap-4 justify-start h-[64px] border-2 rounded-md ">
                        <span className="flex items-center justify-center h-[60px] w-[60px] border-r-2 rounded-md">
                            <User size={40} />
                        </span>
                        <Link to='/' className="font-medium">Continue as a Guest</Link>
                    </button>
                </div>
            </div >
        )
